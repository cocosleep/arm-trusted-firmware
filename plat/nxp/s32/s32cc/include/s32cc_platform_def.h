...
/* FIP Header address in DDR. Align the FIP Header to the page size */
#define FIP_HDR_MAX_SIZE	(0x400)
#define FIP_HDR_BASE		((S32_BL32_BASE - FIP_HDR_MAX_SIZE) & ~PAGE_SIZE_MASK)
